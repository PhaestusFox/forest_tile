    ...
    fn from_world(world: &mut World) -> Self {
        ...
        LoadingTexture {
            ...
            to_load: vec![
                ...
                asset_server.load("no_share/minecraft/textures/block/orange_tulip.png"),
                asset_server.load("no_share/minecraft/textures/block/pink_tulip.png"),
                asset_server.load("no_share/minecraft/textures/block/white_tulip.png"),
                ...
                asset_server.load("no_share/minecraft/textures/block/warped_fungus.png"),
                asset_server.load("no_share/minecraft/textures/block/red_mushroom.png"),
                asset_server.load("no_share/minecraft/textures/block/brown_mushroom.png"),
                asset_server.load("no_share/minecraft/textures/block/rose_bush_top.png"),
                asset_server.load("no_share/minecraft/textures/block/rose_bush_bottom.png"),
            ],
            load_into: target,
        }
    }
